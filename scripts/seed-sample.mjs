 ...
 *
 *   node scripts/seed-sample.mjs [--url http://localhost:4820] [--email ...] [--sandi ...]
 */
...
const EMAIL = arg('email', 'benditandayusaputra@gmail.com');
const SANDI = arg('sandi', 'Contoh-BeDiary-2026!');
...
async function main() {
	...
	const catatan = [
		...
		`Sandi    : ${SANDI}`,
		'',
		`Tulisan  : ${ENTRI.length} entri tersebar di ~3 bulan terakhir`,
		'',
		'24 KATA PEMULIHAN',
		'-'.repeat(50),
