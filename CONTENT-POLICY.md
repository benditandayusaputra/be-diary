...
Kebijakan ini hanya berlaku untuk entri yang **sengaja diterbitkan** penulisnya ke `/read`. Entri
privat tetap terenkripsi dan tidak bisa, serta tidak akan, dipindai siapa pun.
...
be-diary adalah aplikasi diary. Tulisan tentang depresi, kecemasan, duka, dan kesulitan hidup **boleh
...
| 3 laporan valid | Entri disembunyikan otomatis sampai ditinjau |
...
Kirim ke **appeal@be-diary.example** (ganti saat fork) dengan URL entri dan alasannya.
