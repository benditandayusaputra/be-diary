...
<svelte:head>
	<title>Tulisan pribadi · be-diary</title>
...
<div class="ruangan" style="min-height:100vh">
	<div class="shell shell-sempit" style="display:flex;flex-direction:column;gap:var(--s-5)">
		...
		>
			<span
				style="width:15px;height:15px;border-radius:var(--r-pin);background:radial-gradient(circle at 33% 27%, #F3DFAA 0%, #D9A845 32%, var(--pin-brass) 58%, #6E4A12 100%)"
			></span>
