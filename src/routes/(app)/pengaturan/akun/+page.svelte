...
<svelte:head><title>Akun · be-diary</title></svelte:head>
	...
	<div style="display:flex;flex-direction:column;gap:var(--s-5)">
		...
		<div style="display:flex;align-items:center;gap:var(--s-4)">
			...
			<div style="display:flex;flex-direction:column;gap:4px">
				...
				<span class="t-data t-data-ink">
					{sesi.info?.emailVerified ? 'email terverifikasi' : 'email belum terverifikasi'}
				</span>
			</div>
		</div>
		...
		{#if !sesi.info?.emailVerified}
			<div class="pita-peringatan">
				Verifikasi email dulu supaya bisa menerbitkan entri ke halaman publik.
