...
<div class="ruangan" style="display:grid;place-items:center;min-height:100vh;padding:var(--s-6)">
	<div style="display:flex;flex-direction:column;gap:var(--s-5);align-items:center;text-align:center">
		<span
			style="width:19px;height:19px;border-radius:var(--r-pin);background:radial-gradient(circle at 33% 27%, #F3DFAA 0%, #D9A845 32%, var(--pin-brass) 58%, #6E4A12 100%);box-shadow:1px 2px 0 rgb(0 0 0 / 0.3)"
		></span>
