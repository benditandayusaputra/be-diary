...
export class BeDiaryDb extends Dexie {
...
let instance: BeDiaryDb | null = null;

export function localDb(): BeDiaryDb {
	if (!instance) instance = new BeDiaryDb();
	return instance;
}
