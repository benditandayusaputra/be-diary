...
export const AAD_MK = 'be-diary:mk:v1';
export const AAD_RMK = 'be-diary:rmk:v1';
export const INFO_AUTH = 'be-diary:auth:v1';
export const INFO_KEK = 'be-diary:kek:v1';
export const INFO_INDEX = 'be-diary:index:v1';
export const INFO_TRANSFER = 'be-diary:transfer:v1';
export const INFO_RECOVERY_AUTH = 'be-diary:recovery-auth:v1';
