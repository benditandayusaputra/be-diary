...
| Bagian | Keadaan |
|---|---|
| Unit, test vector kriptografi, dan kontras tema | 333 test hijau |
| End-to-end (Playwright) | 30 skenario hijau, termasuk transfer dua perangkat, pemulihan 24 kata, rotasi kunci master, mulai dari nol, centang terverifikasi, dan pencarian feed publik |
