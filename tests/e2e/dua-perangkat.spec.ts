...
test('pemulihan dengan 24 kata membuka arsip di perangkat baru', async ({ browser }) => {
	...
	await baru.locator('input[type="password"]').fill('Sandi-Baru-BeDiary-2026!');
